...
public class KafkaConfig {
    ...
    @Bean
    public KafkaTemplate kafkaTemplate(ProducerFactory<String, Mail> producerFactory)
    {
        KafkaTemplate<String, Mail> kafkaTemplate = new KafkaTemplate<>(producerFactory);
